        ...
        <div class="header-body text-center mb-5">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">di website jadwal sepak bola indonesia</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form action="/auth/register" method="POST"  role="form">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input name="password_confirmation" class="form-control" placeholder="Password Confirmation" type="password" required>
                  </div>
                </div>
